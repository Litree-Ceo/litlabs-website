...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ backgroundColor: "#0a0a0f" }}>
      <div className="fixed top-[-10%] right-[-5%] w-[600px] h-[600px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(0,240,255,0.08) 0%, transparent 70%)" }} />
      <div className="fixed bottom-[-10%] left-[-5%] w-[500px] h-[500px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(255,0,160,0.06) 0%, transparent 70%)" }} />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  onKeyDown={(e) => e.key === "Enter" && document.getElementById("signin-password")?.focus()}
                />
              </div>
            </div>
            ...
            >
              {pending ? <Loader2 size={14} className="animate-spin" /> : <>Sign In <ArrowRight size={14} /></>}
            </button>
          </div>
        ...
        <div className="text-center mt-6 space-y-2">
          ...
          <p className="text-[10px]" style={{ color: "#475569" }}>
            Secured by{" "}
            <span className="font-medium" style={{ color: "#64748b" }}>Clerk</span>
          </p>
        </div>
      </div>
    </div>

  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)] overflow-hidden" style={{ backgroundColor: T.bgColor, color: T.textColor, fontFamily: "monospace" }}>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <main className="flex-1 overflow-hidden flex flex-col w-full" style={{ backgroundColor: T.bgColor, willChange: "transform" }}>
          ...
          >
            ...
            <div className="flex items-center gap-2 shrink-0">
              {/* Coin balance */}
              <div className="flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-bold whitespace-nowrap" style={{ backgroundColor: T.accentColor + "10", color: T.accentColor }}>
                <Coins size={10} /> {litcoins.toLocaleString()} <span className="opacity-60 hidden sm:inline">LiTBit Coins</span>
              </div>
